...
if DF_load_conv1d_1 or DF_load_conv1d_2:
    DF_toload_weights = "results_mat/trainedweights/Heuri1_OLA_L_LR0-002_ME100_BAL_WEIGHTS.mat"
...
filename = "Heuri1_OLA_A_LR{0}_ME{1}".format(word_lr, max_epochs) # I had to change our long filenames, because the 'X' was not die Wahrheit anymore
