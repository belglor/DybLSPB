...
\item Implement an architecture combined of CNN and RNN, as done in \cite{deepspeech} (will probably involve CTC). %if the network architecture allows, use sequences of different lenghts here? And do the curriculum stuff?
